...
INSERT INTO category(categoryName) VALUES ('Dress Shoes');



INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Epic Sneakers', 1, 'very epic',20000.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Dad Sandals',2,'please dont wear socks',40.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Boots',3,'good for hiking or flexing on your friends',80.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Pretentious Dress Shoes',4,'A pair of very pretentious dress shoes',1000.00);

    
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Arnold', 'Anderson', 'a.anderson@gmail.com', '204-111-2222', '103 AnyWhere Street', 'Winnipeg', 'MB', 'R3X 45T', 'Canada', 'arnold' , 'test',0);
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Bobby', 'Brown', 'bobby.brown@hotmail.ca', '572-342-8911', '222 Bush Avenue', 'Boston', 'MA', '22222', 'United States', 'bobby' , 'bobby', 0);
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Candace', 'Cole', 'cole@charity.org', '333-444-5555', '333 Central Crescent', 'Chicago', 'IL', '33333', 'United States', 'candace' , 'password', 0);
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Darren', 'Doe', 'oe@doe.com', '250-807-2222', '444 Dover Lane', 'Kelowna', 'BC', 'V1V 2X9', 'Canada', 'darren' , 'pw', 0);
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Elizabeth', 'Elliott', 'engel@uiowa.edu', '555-666-7777', '555 Everwood Street', 'Iowa City', 'IA', '52241', 'United States', 'beth' , 'test', 0);
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Adam', 'Fox', 'a', 'a', 'a', 'a', 'BC', '52241', 'Canada', 'adam' , 'testpass', 1);
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Corey', 'Cheng', 'a', 'a', 'a', 'a', 'BC', '52241', 'Canada', 'corey' , 'testpass', 1);
...
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 4, 2, 25)
